...
import imageDiko from '../assets/team/diko.png';
...
const team: TeamMember[] = [
  ...
  { 
    ...
    image: imageDiko, 
    urlWebsite: 'https://diko-prasojo.sta.my.id' 
  },
  { 
    id: 3, 
    name: 'Romi Ardianto', 
    ...
    image: imageRomi, 
    urlWebsite: 'https://romi-ardianto.sta.my.id' 
  },
  { 
    id: 4, 
    ...
    image: imageBudi, 
    urlWebsite: 'https://rachmad-udianto.my.id'  
  },
  { 
    id: 5, 
    ...
    image: imageBram, 
    urlWebsite: 'https://bram-krisna-danu.sta.my.id'  
  },
  { 
    id: 6, 
    name: 'M. Aji Perdana', 
    role: 'AI/ML Engineer', 
    image: imageAji, 
    urlWebsite: 'https://aji-perdana.sta.my.id' 
  },
];
  ...
  return (
    <section id="tim" className="py-16 bg-gray-50">
      <div className="container mx-auto px-6">
        <h2 className="text-4xl font-bold text-center mb-12 text-gray-900">Tim Kami</h2>
